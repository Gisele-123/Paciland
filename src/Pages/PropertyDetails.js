...
const PropertyDetails=()=>{
    ...
    return(
        <section>
            <div className='conatiner mx-auto min-h-[800px] mb-14'>
                ...
                <div className='flex flex-col items-start gap-8 lg:flex-row'>
                    <div className='max-w-[768px]'>
                        <div className='mb-8'>
                            <img src={house.imageLg} alt='house or department'/>
                        </div>
                    ...
                    <div className='flex-1 bg-white w-full mb-8 border border-x-gray-300 rounded-lg px-6 py-8'>
                        <div className='flex items-center gap-x-8 mb-8'>
                            <div className='w-20 border border-gray-300 rounded-full'>
                         ...
                         <form className='flex flex-col gap-y-4'>
                            <input className='border border-gray-300 focus:border-violet-700 outline-none rounde w-full px-4 h-14 text-sm' type='text' placeholder='Name*'/>
                            <input className='border border-gray-300 focus:border-violet-700 outline-none rounde w-full px-4 h-14 text-sm' type='text' placeholder='Email*'/>
                            <input className='border border-gray-300 focus:border-violet-700 outline-none rounde w-full px-4 h-14 text-sm' type='text' placeholder='Phone*'/>
